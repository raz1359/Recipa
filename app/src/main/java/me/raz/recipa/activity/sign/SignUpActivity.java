...
import static me.raz.recipa.activity.sign.SignOptionActivity.mAuth;
...
import me.raz.recipa.activity.FillProfileInformationActivity;
...
public class SignUpActivity extends Fragment implements View.OnClickListener {
    ...
    // Constructor
    public SignUpActivity(Context currentContext) {
    ...
    public void createAccount(String email, String password) {
        ...
        mAuth.createUserWithEmailAndPassword(email, password)
                .addOnCompleteListener((Activity) currentContext, (OnCompleteListener<AuthResult>) task -> {
                    if (task.isSuccessful()) {
                        // Sign in success, update UI with the signed-in user's information
                        Log.d(TAG, "createUserWithEmail:success");
                        //FirebaseUser user = mAuth.getCurrentUser();
                        Intent intent = new Intent(currentContext, FillProfileInformationActivity.class);
