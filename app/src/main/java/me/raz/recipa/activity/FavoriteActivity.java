...
public class FavoriteActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private int totalRequests, completedRequests;


    private LinearLayoutManager linearLayoutManagerVertical;
    private List<HighRatingRecipesItem> listFavoritesRecipes = new ArrayList<>();
        ...
        datebaseReference.child("users").child(uID).child("favourites").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (favoriteList != null && !favoriteList.isEmpty()) {
                                ...
                                (Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
                                    ...
                                    public void onResponse(JSONObject response) {
                                        ...
                                        try {
                                            ...
                                            HighRatingRecipesItem favoriteItem = new HighRatingRecipesItem(recipeTitle, imageUrl, recipeId, isFavorite);
                                            ...
                                            if (completedRequests == totalRequests) {
                                                ...
                                                Optional.ofNullable(favoriteRecyclerView.getAdapter()).ifPresent(RecyclerView.Adapter::notifyDataSetChanged);
                                            }
                    ...
                    Toast.makeText(FavoriteActivity.this, "favoriteList is null or empty", Toast.LENGTH_SHORT).show();
